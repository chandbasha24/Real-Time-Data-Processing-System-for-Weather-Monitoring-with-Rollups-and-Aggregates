let weather = {
    apiKey:"c54b6956ec5e961f74b483a2335a1238",
    ...
    document.querySelector(".icon6").src =
        "https://openweathermap.org/img/wn/" + data.list[36].weather[0].icon + ".png";
    document.querySelector(".temp6").innerText = convertTemp(data.list[36].main.temp, selectedUnit) + " °" + selectedUnit;
    document.querySelector(".dt6").innerText = data.list[36].dt_txt;
